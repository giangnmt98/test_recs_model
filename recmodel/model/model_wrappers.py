...
from recmodel.model.model_core import DHashDLRM, DHashNCF, DHashTwoTower
...
class DhashNCFModelWrapper(DeepLearningModelWrapper):
    def build_model(self):
        super().build_model()
        return DHashNCF(self.model_params)

    def load_model(self, model_path: str):
        self.model = DHashNCF.load_from_checkpoint(
            model_path,
            config=self.model_params,
            map_location=self.gpu_loading.get_gpu_map_location(),
        )
